 ...
 */
public class AttentionAdapter extends ZYAdapter<MainContent> {
    ...
    public AttentionAdapter(Context mContext, List<MainContent> mDatas, int mItemLayoutId, View view) {
