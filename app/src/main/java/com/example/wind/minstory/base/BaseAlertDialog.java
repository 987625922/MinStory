...
import com.example.wind.minstory.base.listener.OnBtnClickL;
...
public abstract class BaseAlertDialog<T extends BaseAlertDialog<T>> extends BaseDialog<T> {
    ...
    public BaseAlertDialog(Context context) {
        ...
        /** content */
        mID = new EditText(context);
        mPassword = new EditText(context);
        /**btns*/
    ...
    public void setUiBeforShow() {
        ...
        mTvTitle.setText(TextUtils.isEmpty(mTitle) ? "登陆" : mTitle);
        mTvTitle.setTextColor(mTitleTextColor);
        mTvTitle.setTextSize(TypedValue.COMPLEX_UNIT_SP, mTitleTextSize);

        /** 账号 */
        mID.setGravity(mContentGravity);
        mID.setText(mContent);
        mID.setTextColor(mContentTextColor);
        mID.setTextSize(TypedValue.COMPLEX_UNIT_SP, mContentTextSize);
        mID.setLineSpacing(0, 1.3f);
        /** 密码*/
        mPassword.setGravity(mContentGravity);
        mPassword.setText(mContent);
        mPassword.setTextColor(mContentTextColor);
        mPassword.setTextSize(TypedValue.COMPLEX_UNIT_SP, mContentTextSize);
        mPassword.setLineSpacing(0, 1.3f);
