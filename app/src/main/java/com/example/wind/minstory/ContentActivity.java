...
import com.example.wind.minstory.fragment.ContentFragment;
...
public class ContentActivity extends AppCompatActivity implements OnMenuItemClickListener, OnMenuItemLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initToolbar();
        initMenuFragment();
        addFragment(new ContentFragment(), true, R.id.container);
    }
    ...
    private List<MenuObject> getMenuObjects() {
        ...
        MenuObject like = new MenuObject("赞");
